...
```{r check lack data}
temp <- merged_dataset %>% filter(is.na(to_lat))
```
...
selected_columns <- merged_dataset_station[, c("delay_minutes", "lagsstation", "lags2station", "lags3station", "lags4station", "lags5station", "lags6station")]
cor_delay <- cor(selected_columns, use = "complete.obs")["delay_minutes", -1]%>%
